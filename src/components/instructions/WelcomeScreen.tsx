...
function WelcomeScreen(props: WelcomeProps) {
    ...
    <div className="container" style={{fontFamily: "arial"}}>
        ...
        <br/><br/><h3 style={{fontWeight: "normal"}}>We appreciate your participation.</h3><br/><h3 style={{fontWeight: "normal"}}>{props.numParts == "" ? "This study will take roughly 20 minutes." : "This study has "+props.numParts+" parts. They will take 20 minutes."}</h3><h3 style={{fontWeight: "normal"}}>Please sit approximately 50cm from the screen.<br/>Please make sure that your screen's brightness is turned up.</h3><br/>
